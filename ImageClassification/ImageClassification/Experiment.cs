...
namespace ConsoleApp
{
    ...
    internal class Experiment
    {
        ...
        { 
            ...
            Console.WriteLine("Input Similarity in Label One for images '1_a1' and '1_a2': " + (listInputCorrelation["One1_a1__One1_a2"]) + " %");
            //To check the input similarity between two images of Label 'Nine' and 'One' in InputFolder: 9_pic1.png and 1_pic1.png
            Console.WriteLine("Input Similarity in Between Labels Nine and One for images '9_pic1' and '1_a1': " + (listInputCorrelation["Nine9_pic1__One1_a1"]) + " %");
            #region
            /// <summary>
