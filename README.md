...
## 5. In-Progress
* We are conducting experiments with more images in the training dataset to further analyse the effects of other HTM Parameters on learning of MNIST images.
